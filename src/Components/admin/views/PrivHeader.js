      ...
      <div style={styles.head}>
        ...
        <div style={styles.navStyles}>
          <nav style={styles.navLinks}>
            ...
            >
              ...
              {showSubMenu && (
                <div style={styles.subMenu}>
                  <Link to="/user" style={styles.subNavLink}>
                    usuarios
                  </Link>
                  <Link to="/product" style={styles.subNavLink}>
                    Productos
                  </Link>
            ...
            <Link to="/productos" style={styles.navLink}>
              Productos
            </Link>
            <Link to="/registrarse" style={styles.navLink}>
              Cerrar Sesion
            </Link>
          </nav>
        </div>
