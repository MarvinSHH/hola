...
const styles = {
  ...
  container: {
    //Esta es para el color de la principal
  ...
  imgArea: {
    //Este es para ajustar parametros del lado de la imagen
    width: "2500px",
    minWidth: "200px",
    display: "flex",
    justifyContent: "center",
  ...
  formArea: {
    //Ajusta el parametros del lado de los formularios
    minWidth: "358px",
    width: "1360px",
    maxWidth: "1500px",
    display: "flex",
  ...
  formContainer: {
    //ajuste general de los formularios
  ...
  cincuenta: {
    //usado para separar lo input de nombre y apellido
    display: "flex",
    width: "96%",
    justifyContent: "space-between",
  },
  inCincuenta: {
    //medidas de los imput divididos a la mitad
    width: "45%",
  },
  title: {
    fontSize: 24,
